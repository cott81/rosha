...
//PLUGINLIB_REGISTER_CLASS(VrepSlam_QBFD_Analyzer, vrep_slam_analyzer_plugins::VrepSlam_QBFD_Analyzer, diagnostic_aggregator::Analyzer)

VrepSlam_QBFD_Analyzer::VrepSlam_QBFD_Analyzer() :
    path_(""), has_initialized_(false)

{
  this->CLASSNAME = "VrepSlam_QBFD_Analyzer";
  cout << "\n\n\n VrepSlam_QBFD_Analyzer: const\n\n\n" << endl;
...
bool VrepSlam_QBFD_Analyzer::init(const string base_name, const ros::NodeHandle &n)
{
  ...
  {
    ROS_WARN ("No path parameter was specified in VrepSlam_QBFD_Analyzer! Use no parent item.");
  } else {
  ...
  {
    ROS_WARN ("No cap parameter was specified in VrepSlam_QBFD_Analyzer! Use no parent item.");
  } else {
  ...
  {
    ROS_WARN ("No func parameter was specified in VrepSlam_QBFD_Analyzer! Use no parent item.");
  } else {
  ...
  {
    ROS_ERROR(
        "No power board name was specified in VrepSlam_QBFD_Analyzer! Power board must be \"Power board 10XX\". Namespace: %s", n.getNamespace().c_str());
    return false;
  }
  ...
  */
  ...
  std::string path2 = path+"vrep_slam_CSFailureModel_dbn.xdsl"; //dbn for the fdd eval experiment
...
bool VrepSlam_QBFD_Analyzer::match(const std::string name)
{
