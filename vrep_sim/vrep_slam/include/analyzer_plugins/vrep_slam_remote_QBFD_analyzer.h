#ifndef VREP_SLAM_REMOTE_ANALYZER_H
#define VREP_SLAM_REMOTE_ANALYZER_H
...
class VrepSlamRemote_QBFD_Analyzer : public diagnostic_aggregator::Analyzer
{
public:
  VrepSlamRemote_QBFD_Analyzer();
...
#endif //VREP_SLAM_REMOTE_ANALYZER_H
