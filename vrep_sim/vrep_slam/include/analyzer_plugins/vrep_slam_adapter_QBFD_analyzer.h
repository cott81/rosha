#ifndef VREP_SLAM_ADAPTER_ANALYZER_H
#define VREP_SLAM_ADAPTER_ANALYZER_H
...
class VrepSlamAdapter_QBFD_Analyzer : public diagnostic_aggregator::Analyzer
{
public:
  VrepSlamAdapter_QBFD_Analyzer();
...
#endif //VREP_SLAM_ADAPTER_ANALYZER_H
