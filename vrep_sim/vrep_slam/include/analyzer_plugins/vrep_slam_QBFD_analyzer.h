#ifndef VREP_SLAM_ANALYZER_H
#define VREP_SLAM_ANALYZER_H
...
class VrepSlam_QBFD_Analyzer : public diagnostic_aggregator::Analyzer
{
public:
  VrepSlam_QBFD_Analyzer();
