#ifndef VREP_LASER_DRIVER_ANALYZER_H
#define VREP_LASER_DRIVER_ANALYZER_H
...
namespace vrep_laser_driver_analyzer_plugins {


class VrepLaserDriver_QBFD_Analyzer : public diagnostic_aggregator::Analyzer
{
public:
  VrepLaserDriver_QBFD_Analyzer();
