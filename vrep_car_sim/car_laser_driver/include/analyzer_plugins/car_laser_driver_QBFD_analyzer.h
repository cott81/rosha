#ifndef CAR_LASER_DRIVER_ANALYZER_H
#define CAR_LASER_DRIVER_ANALYZER_H
...
namespace car_laser_driver_analyzer_plugins {


class CarLaserDriver_QBFD_Analyzer : public diagnostic_aggregator::Analyzer
{
public:
  CarLaserDriver_QBFD_Analyzer();
...
#endif //CAR_LASER_DRIVER_ANALYZER_H
