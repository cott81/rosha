#ifndef PROXIMITY_OBSTACLEDETECTION_ANALYZER_H
#define PROXIMITY_OBSTACLEDETECTION_ANALYZER_H
...
namespace proximity_obstacledetection_analyzer_plugins {


class Proximity_Obstacledetection_QBFD_Analyzer : public diagnostic_aggregator::Analyzer
{
public:
  Proximity_Obstacledetection_QBFD_Analyzer();
...
#endif //VREP_LASER_DRIVER_ANALYZER_H
