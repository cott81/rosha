#ifndef CAR_LOCALIZER_ANALYZER_H
#define CAR_LOCALIZER_ANALYZER_H
...
namespace car_localizer_analyzer_plugins {


class Car_Localizer_QBFD_Analyzer : public diagnostic_aggregator::Analyzer
{
public:
  Car_Localizer_QBFD_Analyzer();
