#ifndef CAMERA_CARDETECTION_ANALYZER_H
#define CAMERA_CARDETECTION_ANALYZER_H
...
namespace camera_cardetection_analyzer_plugins {


class Camera_CarDetection_QBFD_Analyzer : public diagnostic_aggregator::Analyzer
{
public:
  Camera_CarDetection_QBFD_Analyzer();
