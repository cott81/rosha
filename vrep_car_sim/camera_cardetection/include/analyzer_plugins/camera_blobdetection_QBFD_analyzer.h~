#ifndef CAMERA_BLOBDETECTION_ANALYZER_H
#define CAMERA_BLOBDETECTION_ANALYZER_H
...
namespace camera_blobdetection_analyzer_plugins {


class Camera_BlobDetection_QBFD_Analyzer : public diagnostic_aggregator::Analyzer
{
public:
  Camera_BlobDetection_QBFD_Analyzer();
