#ifndef CAMERA_STREETDETECTION_ANALYZER_H
#define CAMERA_STREETDETECTION_ANALYZER_H
...
namespace camera_streetdetection_analyzer_plugins {


class Camera_StreetDetection_QBFD_Analyzer : public diagnostic_aggregator::Analyzer
{
public:
  Camera_StreetDetection_QBFD_Analyzer();
