#ifndef CAR_MOTION_ANALYZER_H
#define CAR_MOTION_ANALYZER_H
...
namespace car_motion_analyzer_plugins {


class Car_Motion_QBFD_Analyzer : public diagnostic_aggregator::Analyzer
{
public:
  Car_Motion_QBFD_Analyzer();
