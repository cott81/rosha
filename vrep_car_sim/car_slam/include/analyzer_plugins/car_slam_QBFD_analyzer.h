#ifndef CAR_SLAM_ANALYZER_H
#define CAR_SLAM_ANALYZER_H
...
class CarSlam_QBFD_Analyzer : public diagnostic_aggregator::Analyzer
{
public:
  CarSlam_QBFD_Analyzer();
