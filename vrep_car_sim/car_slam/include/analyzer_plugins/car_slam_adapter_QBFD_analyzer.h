#ifndef CAR_SLAM_ADAPTER_ANALYZER_H
#define CAR_SLAM_ADAPTER_ANALYZER_H
...
namespace car_slam_analyzer_plugins {


class CarSlamAdapter_QBFD_Analyzer : public diagnostic_aggregator::Analyzer
{
public:
  CarSlamAdapter_QBFD_Analyzer();
...
#endif //CAR_SLAM_ADAPTER_ANALYZER_H
