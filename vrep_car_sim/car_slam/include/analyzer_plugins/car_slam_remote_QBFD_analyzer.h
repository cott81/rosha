#ifndef CAR_SLAM_REMOTE_ANALYZER_H
#define CAR_SLAM_REMOTE_ANALYZER_H
...
class CarSlamRemote_QBFD_Analyzer : public diagnostic_aggregator::Analyzer
{
public:
  CarSlamRemote_QBFD_Analyzer();
...
#endif //CAR_SLAM_REMOTE_ANALYZER_H
