...
//PLUGINLIB_REGISTER_CLASS(CarSlamAdapter_QBFD_Analyzer, vrep_slam_analyzer_plugins::CarSlamAdapter_QBFD_Analyzer, diagnostic_aggregator::Analyzer)

CarSlamAdapter_QBFD_Analyzer::CarSlamAdapter_QBFD_Analyzer() :
    path_(""), has_initialized_(false)

{
  this->CLASSNAME = "CarSlamAdapter_QBFD_Analyzer";
  cout << "\n\n\n CarSlamAdapter_QBFD_Analyzer: const\n\n\n" << endl;
...
bool CarSlamAdapter_QBFD_Analyzer::match(const std::string name)
{
...
bool CarSlamAdapter_QBFD_Analyzer::unmatch(const std::string name)
{
...
bool CarSlamAdapter_QBFD_Analyzer::analyze(const boost::shared_ptr<StatusItem> item)
{
...
vector<boost::shared_ptr<diagnostic_msgs::DiagnosticStatus> > CarSlamAdapter_QBFD_Analyzer::report()
{
