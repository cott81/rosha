#ifndef CAR_INERTIA_ANALYZER_H
#define CAR_INERTIA_ANALYZER_H
...
namespace car_inertia_analyzer_plugins {


class CarInertia_QBFD_Analyzer : public diagnostic_aggregator::Analyzer
{
public:
  CarInertia_QBFD_Analyzer();
